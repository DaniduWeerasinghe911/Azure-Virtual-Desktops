...
@description('Enable a option to disable flow logs.  Useful for production workloads.')
...
/*
@description('nsg flow logs storge ID')
param storageId string

@description('nsg flow logs storge ID')
param networkWacherRg string

@description('nsg flow logs storge ID')
param networkWacherName string
