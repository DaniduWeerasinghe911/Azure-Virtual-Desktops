    ...
    privateDnsZoneConfigs: [
      {
        ...
        properties: {
          privateDnsZoneId: '/subscriptions/${dnsZoneSubscriptionId}/resourceGroups/${dnsZoneResourceGroup}/providers/Microsoft.Network/privateDnsZones/privatelink.vaultcore.azure.net'
        }
      }
    ]
  }
